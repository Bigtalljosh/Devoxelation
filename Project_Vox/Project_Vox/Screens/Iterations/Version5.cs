/* Version 5 builds on version 4  *
 *  Toggle the culling from clockwise to counter clockwise with SPACE
 */
...
{
    public class Version5 : GameScreen
    {
        #region Fields
        ...
        string rasterText = "Rasteriser Culling: ";
        string raster;
        Vector2 rasterTextLocation = new Vector2(10, 50);
        Vector2 rasterLocation = new Vector2(140, 50);

        string cullText = "Culled from frustum: ";
        string cull;
        Vector2 cullTextLocation = new Vector2(10, 70);
        Vector2 cullLocation = new Vector2(160, 70);
        ...
        BoundingFrustum bf; //Used for Frustum Culling - Creates a bounding box/sphere 
        OcclusionQuery occlusionCull;
        ...
        public void displayFPS(GameTime gameTime)
        {
            ...
            //Raster State
            spriteBatch.DrawString(kootenayFont, rasterText, rasterTextLocation, Color.Red);
            spriteBatch.DrawString(kootenayFont, raster, rasterLocation, Color.Red);
            //culled
            cull = culled.ToString();
            spriteBatch.DrawString(kootenayFont, cullText, cullTextLocation, Color.Red);
            spriteBatch.DrawString(kootenayFont, cull, cullLocation, Color.Red);
            spriteBatch.End();
        }
